                    ...
                    @foreach ($blogs as $blog )
                        <tr class="hover:bg-gray-100 transition">
                            ...
                            <td class="px-4 py-3 flex justify-center space-x-2">
                                ...
                                <form action="{{ route('blog.destroy',$blog) }}" method="post" onsubmit="return confirm('Are you sure you want to delete this blog?');">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="px-3 py-1 bg-red-500 text-white text-xs font-semibold rounded shadow-md hover:bg-red-600 transition">
                                        🗑 Delete
                                    </button>
                            </td>
                        </tr>
